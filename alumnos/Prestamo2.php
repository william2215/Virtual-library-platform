<html>
    ...
    $Fecha_retiro = $_POST['Fecha_retiro']; //formato en que obtendra la fecha y hora
	...
	<section class="bg-light" id="about">
		...
		<table border="0" class="table table-light table-xl">
			...
			<tr>
                ...
                <td align="center"><input type="button" onclick="location='Catalogo.php'" value="Cancelar"</td>
			</tr>
		</table>
	</form>
     </div>
